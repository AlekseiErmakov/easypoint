...
@Service
public class AreaStructureTypeService extends DictionaryService<AreaStructureType, AreaStructureTypeDto, AreaStructureTypeCreateDto, AreaStructureTypeUpdateDto> {
